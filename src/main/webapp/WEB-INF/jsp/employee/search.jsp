...
<div id="contents">
  ...
  <div>
  	<label class="label">:::: 성 &nbsp;&nbsp; 별 ::::</label>
  	 <input name="sex" type="text" class="INPUT" placeholder="남자  / 여자"> 
  </div>	 
  <div>
  ...
  <div>
  	<label class="label">:::: 주 &nbsp;&nbsp; 소 ::::</label>
  	 <input name="adress" type="text" class="INPUT" placeholder="ex)서울시"> 
  </div>	
  <button id="serchBtn" style="margin-left: 227px;">검색</button>
  </form>
  </div>
  <div id="naviBar">
  <!-- 선택삭제기능 -->
