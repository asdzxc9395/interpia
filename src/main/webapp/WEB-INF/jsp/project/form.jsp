                    ...
                    <td height="26" align="center" bgcolor="#E4EBF1"><strong>                      </strong>
                      <table width="494" border="0" cellpadding="0" cellspacing="0">
                        <tr align="left">
                          ...
                          <td width="160"><strong>
                            <input name="projectName" type="text" size="20" >
                          </strong></td>
                          <td width="75"><strong>참여기간</strong></td>
                          <td width="173"><strong>
                          </strong><strong>
                          <input name="startDate" type="date" size="10" value="2020-06-09">
~ 							
							<input name="endDate" type="date" size="10" value="2020-06-09">
						</strong></td>
                          </tr>
                      </table>                      </td>
                    </tr>
                  <tr>
                    <td height="26" align="center" bgcolor="#E4EBF1"><table width="494" border="0" cellpadding="0" cellspacing="0">
                      <tr align="left">
                        ...
                        <td width="162"><strong>
                          <input name="custmor" type="text" size="20" >
                        </strong></td>
                  ...
                  <tr>
                    <td height="26" align="center" bgcolor="#E4EBF1"><table width="494" border="0" cellpadding="0" cellspacing="0">
                      <tr align="left">
                        ...
                        <td width="207"><strong> </strong><strong>
                          <input name="role" type="text" size="30" >
                        </strong></td>
                      </tr>
                    </table></td>
                  </tr>
                    ...
                    <tr> 
                      <td height="26" align="center" bgcolor="#E4EBF1"><table width="480" border="0" cellpadding="0" cellspacing="0">
                        <tr align="left">
                          ...
                          <td width="198"><strong>
                            <input name="model" type="text" size="25" >
</strong></td>
                          <td width="38"><strong>OS</strong></td>
                          <td width="190"><strong> </strong><strong>
                            <input name="os" type="text" size="25" >
                            </strong></td>
                        </tr>
                      </table></td>
                    </tr>
                    <tr> 
                      <td height="26" align="center" valign="middle" bgcolor="#E4EBF1"><table width="480" border="0" cellpadding="0" cellspacing="0">
                        <tr align="left">
                          ...
                          <td width="198"><strong>
                            <input name="language" type="text" size="25">
                          </strong></td>
                          <td width="60"><strong>DBMS</strong></td>
                          <td width="168"><strong> </strong><strong>
                            <input name="dbms" type="text" size="25" >
                          </strong></td>
                        </tr>
                      </table></td>
                    </tr>
                    <tr> 
                      <td height="26" align="center" bgcolor="#E4EBF1"><table width="480" border="0" cellpadding="0" cellspacing="0">
                        <tr align="left">
                          ...
                          <td width="202"><strong>
                            <input name="tool" type="text" size="25">
                          </strong></td>
                          <td width="44"><strong>통신</strong></td>
                          <td width="185"><strong> </strong><strong>
                            <input name="comunication" type="text" size="25" >
                          </strong></td>
                        </tr>
                      </table></td>
                    </tr>
                    <tr>
                      <td height="26" align="center" bgcolor="#E4EBF1"><table width="480" border="0" cellpadding="0" cellspacing="0">
                        <tr align="left">
                          ...
                          <td width="429"><strong>
                            <input name="etc" type="text" size="50">
