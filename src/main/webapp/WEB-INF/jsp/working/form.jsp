                  ...
                  <tr>
                    <td height="26" align="center" bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                      <tr>
                        ...
                        <td width="391"><input name="projectName" type="text" size="40">
                          </td>
                      </tr>
                    </table>                      
                      </td>
                  ...
                  <tr>
                    <td height="26" align="center" bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                      <tr>
                        ...
                        <td width="391"><input name="workPlace" type="text" size="40">
                        </td>
                      </tr>
                    </table></td>
                  </tr>
                  <tr>
                    <td height="26" align="center" bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                      <tr>
                        ...
                        <td width="151"><input name="startDate" type="Date" size="15" value="2020-06-09">
                        </td>
                        <td width="94"><strong>근무종료일</strong></td>
                        <td width="141"><input name="endDate" type="Date" size="15" value="2020-06-09"></td>
                      </tr>
                    </table></td>
                  </tr>
                  <tr>
                    <td height="22" align="center" bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                      <tr>
                        ...
                        <td width="151"><input name="profit" type="number" size="15" value="1">
                        </td>
                        <td width="117">&nbsp;</td>
                        <td width="118">&nbsp;</td>
                      </tr>
                  ...
                  <tr>
                    <td height="22" align="center" bgcolor="#E4EBF1"><table width="500" border="0" cellspacing="1" cellpadding="1">
                      <tr>
                        ...
                        <td width="151"><input name="paymentDueDate" type="Date" size="15" value="2020-06-09"></td>
                        </td>
                        <td width="96" align="center"><strong>결제일</strong></td>
                        <td width="139"><input name="paymentDate" type="Date" size="15" value="2020-06-09">
                      </tr>
                    </table></td>
                  </tr>
              </table></td>
