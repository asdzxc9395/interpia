...
public class Education implements Serializable{
	...
	public String toString() {
		return "Education [employee=" + employee + ", eudcationNo=" + eudcationNo + ", hsName=" + hsName + ", hsMajor="
	...
	public void setEudcationNo(int eudcationNo) {
		this.eudcationNo = eudcationNo;
	}
